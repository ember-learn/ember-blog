...
- `Model.save()` will return a native `Promise` instead of a `PromiseProxyMixin`. To return a `Promise`, you can [set your `compatWith` to 4.4](https://api.emberjs.com/ember-data/4.4/modules/@ember-data%2Fdeprecations). ([#7868](https://github.com/emberjs/data/pull/7868)
