...
- `Model.save()` will return a Promise instead of a `PromiseProxyMixin`. To return a `Promise`, you can [set your `compatWith` to 4.4](https://api.emberjs.com/ember-data/release/modules/@ember-data%2Fdeprecations). ([#7868](https://github.com/emberjs/data/pull/7868)
