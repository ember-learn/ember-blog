...
- Use Title Case for section headings. When in doubt use [titlecase](https://titlecase.com/).
- Please add an emoji at the end of your title. If you're having trouble finding an emoji use a search tool like [emojipedia](https://emojipedia.org/).
